export default {
  ...
  home: {
    ...
    mergeEnterSelection: 'Select PDFs',
    reviewAppAction: 'Rate app',
  ...
  history: {
    ...
    mergeProgressTitle: 'Merging PDFs',
    mergeProgressValidating: 'Validating selected files...',
    mergeProgressPreparing: 'Preparing documents...',
    mergeProgressReading: 'Reading PDFs...',
    mergeProgressMerging: 'Processing merge...',
    mergeProgressWriting: 'Writing final file...',
    mergeProgressFinalizing: 'Updating history...',
    mergeProgressDone: 'Merge completed!',

    renameAction: 'Rename',
    shareAction: 'Share',
    exportAction: 'Export / Save to device',
    duplicateAction: 'Duplicate',
    protectAction: 'Protect with password',
    deleteAction: 'Delete',
  ...
  save: {
    ...
    jpegSavedOnly: 'JPEG saved in the app. (Export to gallery failed.)',
  ...
  pdfProtection: {
    ...
    protectTitle: 'Protect PDF with password',
    enableToggle: 'Protect with password',
    passwordPlaceholder: 'Password',
    confirmPlaceholder: 'Confirm password',
    passwordHint: 'Password must have at least %{min} characters.',
    disabledHint: 'Without password protection, export runs as usual.',
    ...
    notSupportedOnDevice: 'Password protection is unavailable on this device.',
    failedToCreate: 'Failed to create protected PDF.',
    protectSuccess: 'Protected copy created successfully.',
    onlyPdfSupported: 'Password protection is available only for PDF files.',
  },
};
